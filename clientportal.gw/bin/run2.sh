...
export RUNTIME_PATH="$config_path:/app/clientportal.beta.gw/dist/ibgroup.web.core.iblink.router.clientportal.gw.jar:/app/clientportal.beta.gw/build/lib/runtime/*"
